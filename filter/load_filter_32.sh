...
#Copiar el filter
sshpass -p "analog" scp filter_jupyter.txt root@192.168.1.32:/jonathan/
sshpass -p "analog" scp filter root@192.168.1.32:/jonathan/
#ejecuta
#sshpass -p "analog" ssh -t root@192.168.1.37 /jonathan/filter
sshpass -p "analog" ssh -t root@192.168.1.32 "cd /jonathan/; exec ./filter"
